...
export class MemStorage implements IStorage {
  ...
  private loadCSVData() {
    try {
      ...
      const expensePaths2026 = [
        ...
        "attached_assets/Practice_Program_Expense_data_(Apr_2026)_1778590451307.csv",
      ];
  ...
  async createExpense(expense: InsertExpense): Promise<Expense> {
    ...
    const newExpense: Expense = { 
      ...
      caseGroupName: expense.caseGroupName ?? null,
  ...
  async getExpenseDetails(
    ...
    return filtered.map(exp => ({
      ...
      caseGroupName: exp.caseGroupName || '',
  ...
  private loadIPTeamsData() {
    const ipFiles: { year: number; paths: string[] }[] = [
      ...
      { year: 2026, paths: [
        ...
        "attached_assets/IP_data_(Mar_2026)_1776266237672.csv",
        "attached_assets/IP_data_(Apr_2026)_1778513694387.csv",
      ]},
    ];
